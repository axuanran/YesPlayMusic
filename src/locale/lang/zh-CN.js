export default {
  ...
  settings: {
    ...
    desktopLyrics: {
      ...
      center: '居中',
      right: '右对齐',
      overflowBehavior: '歌词超出窗口时',
      ellipsis: '使用省略号',
      wrap: '换行显示',
      verticalPosition: '歌词竖向位置',
      top: '顶部',
      bottom: '底部',
      ...
      resetStyle: '重置样式',
      styleTemplates: '样式模板',
      styleTemplatesDescription: '应用内置模板，或使用已保存的自定义样式。',
      applyTemplate: '应用',
      deleteTemplate: '删除',
      saveTemplate: '保存当前样式',
      templateName: '模板名称',
      templateApplied: '已应用桌面歌词样式',
      templateSaved: '已保存桌面歌词样式',
  ...
  cachedTracks: {
    ...
    play: '播放',
    partial: '部分缓存',
    partialCannotPlay: '该缓存尚不完整，暂时无法离线播放',
    remove: '删除',
    close: '关闭',
