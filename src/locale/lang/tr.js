export default {
  ...
  player: {
    ...
    lyricsBehavior: 'Şarkı sözü davranışı',
    lyricsBehaviorShort: 'Sözler',
    ...
    lyricsResumeFollowShort: 'Geçerli söze dön',
  },
  modal: {
    close: 'Kapat',
  },
  ...
  settings: {
    ...
    desktopLyrics: {
      ...
      center: 'Orta',
      right: 'Sağ',
      overflowBehavior: 'Sözler pencereyi aştığında',
      ellipsis: 'Üç nokta ile kısalt',
      wrap: 'Birden çok satıra kaydır',
      verticalPosition: 'Dikey söz konumu',
      top: 'Üst',
      bottom: 'Alt',
      ...
      styleTemplates: 'Stil şablonları',
      styleTemplatesDescription:
        'Yerleşik bir şablon veya kaydedilmiş özel bir stil uygula.',
      applyTemplate: 'Uygula',
      deleteTemplate: 'Sil',
      saveTemplate: 'Geçerli stili kaydet',
      templateName: 'Şablon adı',
      templateApplied: 'Masaüstü sözleri stili uygulandı',
      templateSaved: 'Masaüstü sözleri stili kaydedildi',
  ...
  cachedTracks: {
    ...
    play: 'Oynat',
    partial: 'Kısmi',
    partialCannotPlay: 'Bu önbellek tamamlanmadı ve çevrimdışı oynatılamaz',
    remove: 'Sil',
    close: 'Kapat',
