export default {
  ...
  settings: {
    ...
    desktopLyrics: {
      ...
      center: '置中',
      right: '靠右',
      overflowBehavior: '歌詞超出視窗時',
      ellipsis: '使用省略號',
      wrap: '換行顯示',
      verticalPosition: '歌詞垂直位置',
      top: '頂部',
      bottom: '底部',
      ...
      resetStyle: '重設樣式',
      styleTemplates: '樣式範本',
      styleTemplatesDescription: '套用內建範本，或使用已儲存的自訂樣式。',
      applyTemplate: '套用',
      deleteTemplate: '刪除',
      saveTemplate: '儲存目前樣式',
      templateName: '範本名稱',
      templateApplied: '已套用桌面歌詞樣式',
      templateSaved: '已儲存桌面歌詞樣式',
  ...
  cachedTracks: {
    ...
    play: '播放',
    partial: '部分快取',
    partialCannotPlay: '此快取尚未完成，暫時無法離線播放',
    remove: '刪除',
    close: '關閉',
